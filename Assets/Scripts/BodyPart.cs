...
public class BodyPart : MonoBehaviour
{
    ...
    //Represents the positionand rotation that the blood a fountain will appear at on the main body
    public Transform bloodFountainOrigin;

    //If true, this object will remove its collision, joints, and rigid body when it comes to rest
    bool detached = false;

    //Decouple this object from the parent,
    //and flag it as needing physics removal
    public void Detach()
    {
        detached = true;
        this.tag = "Untagged";
    ...
    public void Update()
    {
        //If no sprite is detached do nothing
        if (detached == false)
        {
            return;
        }
    ...
    //Swaps out the sprites for this part based on what kind of damage was recived
